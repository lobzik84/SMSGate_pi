 ...
 * @author lobzik
 */
public class SMSClientTestXMLGroup {
    ...
    static String text = "Это тест отправки sms группе получателей через XML: " + System.currentTimeMillis();
    static String admin = "dataminer";   
    static String group = "rtest";
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    adminEl.appendChild(doc.createTextNode(admin));
                    message.appendChild(adminEl);
                    
                    Element groupEl = doc.createElement("group");
                    groupEl.appendChild(doc.createTextNode(group));
                    message.appendChild(groupEl);
